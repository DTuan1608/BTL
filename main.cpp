...
int main() {
    ...
    Dich_vu DV4 = {"Chup X-Quang", "CXQ",600000};
    Dich_vu DV5 = {"Kham tim mach", "TM",600000};
    Dich_vu DV6 = {"Sinh thiet te bao ung thu", "STTB", 2000000};
    Dich_vu DV7 = {"Chup MRI", "MRI", 800000};
